...
public static class CheckerboardGeometry
{
	...
	// 戻り値の型は Microsoft.UI.Xaml.Media.Geometry。この名前空間 Irozukume.Controls.Geometry の名と同名のため完全修飾する。
	public static Microsoft.UI.Xaml.Media.Geometry BuildDarkCells(double width, double height, double cell)
	{
